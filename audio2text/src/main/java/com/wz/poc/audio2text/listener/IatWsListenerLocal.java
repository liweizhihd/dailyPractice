 ...
 */
@Slf4j
public class IatWsListenerLocal extends WebSocketListener {
    ...
    public IatWsListenerLocal(Audio2textParamConfig config, String audioUrl, LinkedBlockingQueue<String> blockingQueue) {
        this.config = config;
    ...
    public void onOpen(@NotNull WebSocket webSocket, @NotNull Response response) {
        ...
        // 从本地文件读取音频对象
        try (FileInputStream fs = new FileInputStream("C:\\Users\\liweizhi\\Desktop\\download.mp3")) {
            ...
            while (true) {
                ...
                switch (status) {
                    case Audio2textConstant.STATUS_FIRST_FRAME:
                        ...
                        log.info("send start");
                        break;
                    case Audio2textConstant.STATUS_CONTINUE_FRAME:
                    ...
                    case STATUS_LAST_FRAME:
                        ...
                        break end;
                    default:
                        log.error("this show never be executed");
                }
            }
        ...
        if (resp != null) {
            ...
            if (resp.getData() != null) {
                ...
                if (resp.getData().getStatus() == 2) {
                    ...
                    blockingQueue.offer(textToString);
